...
Multiple problems, explained in detail [here](https://github.com/InvaderXim/server/wiki/Sol-Refactor).
...
- As mentioned in the [refactor notes](https://github.com/InvaderXim/server/wiki/Sol-Refactor), performance is through the roof.
