...
local content = Limbus:new({
    ...
    battlefieldId    = invaderXim.battlefield.id.TEMENOS_WESTERN_TOWER,
    maxPlayers       = 18,
...
content.groups =
{
...

    {
        ...
        mobMods = { [invaderXim.mobMod.LINK_RADIUS] = 8 },
...
content.loot =
{
    ...
    [ID.npc.W_LOOT_CRATE] =
    {
        ...
        {
            { item = invaderXim.item.EMERALD_CHIP, weight = invaderXim.loot.weight.NORMAL },
        },
