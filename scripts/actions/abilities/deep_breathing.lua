...
abilityObject.onAbilityCheck = function(player, target, ability)
    return invaderXim.job_utils.dragoon.abilityCheckDeepBreathing(player, target, ability)
end

abilityObject.onUseAbility = function(player, target, ability)
    invaderXim.job_utils.dragoon.useDeepBreathing(player, target, ability)
end
