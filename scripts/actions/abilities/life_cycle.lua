...
abilityObject.onAbilityCheck = function(player, target, ability)
    return invaderXim.job_utils.geomancer.geoOnLifeCycleAbilityCheck(player, target, ability)
end

abilityObject.onUseAbility = function(player, target, ability)
    return invaderXim.job_utils.geomancer.lifeCycle(player, target, ability)
end
