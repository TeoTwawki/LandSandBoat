...
abilityObject.onPetAbility = function(target, pet, petskill, summoner, action)
    ...
    local baseDamage = invaderXim.summon.avatarPhysicalMove(pet, target, petskill, 2, 1, 10, 1, invaderXim.mobskills.magicalTpBonus.NO_EFFECT, 1, 2, 3)
    ...
    damage = invaderXim.summon.avatarFinalAdjustments(damage, pet, petskill, target, invaderXim.attackType.PHYSICAL, invaderXim.damageType.BLUNT, 3)
