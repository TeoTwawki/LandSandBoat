...
abilityObject.onAbilityCheck = function(player, target, ability)
    ...
    return invaderXim.job_utils.dragoon.abilityCheckRequiresPet(player, target, ability, true)
end

abilityObject.onUseAbility = function(player, target, ability, action)
    invaderXim.job_utils.dragoon.useRestoringBreath(player, ability, action)
end
