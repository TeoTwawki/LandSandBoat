...
--  Blade Metsu
--
--  Description: Additional effect: Paralysis Kikoku/Yoshimitsu: Temporarily enhances Subtle Blow invaderXim.effect.
--  Type: Physical
--  Range: Melee
-----------------------------------
---@type TMobSkill
...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    invaderXim.mobskills.mobPhysicalStatusEffectMove(mob, target, skill, invaderXim.effect.PARALYSIS, 10, 0, 60) -- Is this real...?
