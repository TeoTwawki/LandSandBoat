...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    skill:setMsg(invaderXim.mobskills.mobStatusEffectMove(mob, target, invaderXim.effect.WEAKNESS, 1, 0, 90))

    mob:takeDamage(dmg1)
    target:takeDamage(dmg2, mob, invaderXim.attackType.MAGICAL, invaderXim.damageType.ELEMENTAL)
