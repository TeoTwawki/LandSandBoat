...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    damage = invaderXim.mobskills.mobMagicalMove(mob, target, skill, damage, invaderXim.element.FIRE, 1.8, invaderXim.mobskills.magicalTpBonus.NO_EFFECT)
    ...
    invaderXim.mobskills.mobStatusEffectMove(mob, target, invaderXim.effect.BURN, 21, 3, 60)
