...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    invaderXim.mobskills.mobStatusEffectMove(mob, target, invaderXim.effect.BIO, 5, 3, 120, 0, 10)
    invaderXim.mobskills.mobStatusEffectMove(mob, target, invaderXim.effect.MAX_HP_DOWN, 10, 0, 120)
