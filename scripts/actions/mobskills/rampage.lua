...
mobskillObject.onMobSkillCheck = function(target, mob, skill)
    mob:messageBasic(invaderXim.msg.basic.READIES_WS, 0, 684 + 256)
    return 0
end
...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local accmod = 1
    local ftp    = 1.5
    local info = invaderXim.mobskills.mobPhysicalMove(mob, target, skill, numhits, accmod, ftp, invaderXim.mobskills.physicalTpBonus.CRIT_VARIES, 1, 1.5, 2)
