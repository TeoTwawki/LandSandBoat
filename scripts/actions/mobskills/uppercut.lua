...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local accmod  = 1
    local ftp     = 3
    local info    = invaderXim.mobskills.mobPhysicalMove(mob, target, skill, numhits, accmod, ftp, invaderXim.mobskills.physicalTpBonus.ATK_VARIES, 2.0, 2.0, 2.0) -- TODO: this apparently can crit
