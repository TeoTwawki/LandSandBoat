...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    caster:addStatusEffect(invaderXim.effect.ATTACK_BOOST, attBoost, 0, duration)
    caster:addStatusEffect(invaderXim.effect.MAGIC_ATK_BOOST, magAttBoost, 0, duration)
