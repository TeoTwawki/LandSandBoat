...
local content = Battlefield:new({
    ...
    battlefieldId = invaderXim.battlefield.id.FACTORY_REJECTS,
    maxPlayers    = 6,
    levelCap      = 40,
...
{
    {
        { item = invaderXim.item.DOLL_SHARD, weight = 1000 }, -- doll_shard
    },

    {
        { item = invaderXim.item.VIAL_OF_MERCURY, weight = 1000 }, -- vial_of_mercury
    },
...

    {
        ...
        { item = invaderXim.item.RAIFU,            weight = 250 }, -- raifu
        { item = invaderXim.item.BUZZARD_TUCK,     weight = 250 }, -- buzzard_tuck
        { item = invaderXim.item.JONGLEURS_DAGGER, weight = 250 }, -- jongleurs_dagger
    },

    {
        { item = invaderXim.item.NONE,             weight = 200 }, -- nothing
        { item = invaderXim.item.REARGUARD_MANTLE, weight = 400 }, -- rearguard_mantle
        { item = invaderXim.item.AGILE_MANTLE,     weight = 400 }, -- agile_mantle
    },
