...
local content = Battlefield:new({
    ...
    battlefieldId    = invaderXim.battlefield.id.COMPLIMENTS_TO_THE_CHEF,
    maxPlayers       = 6,
    levelCap         = 75,
...
content.loot =
{
    ...
    {
        { item = invaderXim.item.CHUNK_OF_OROBON_MEAT, weight = invaderXim.loot.weight.NORMAL },
    },
    ...
    {
        { item = invaderXim.item.NONE, weight = invaderXim.loot.weight.EXTREMELY_HIGH },
        { item = invaderXim.item.BITTER_CORSET, weight = invaderXim.loot.weight.VERY_LOW },
        { item = invaderXim.item.KAWAHORI_KABUTO, weight = invaderXim.loot.weight.VERY_LOW },
        { item = invaderXim.item.REQUIEM_FLUTE, weight = invaderXim.loot.weight.VERY_LOW },
        { item = invaderXim.item.TENSION_SPRING_II, weight = invaderXim.loot.weight.EXTREMELY_LOW },
        { item = invaderXim.item.ACCELERATOR_II, weight = invaderXim.loot.weight.EXTREMELY_LOW },
        { item = invaderXim.item.ARMOR_PLATE_II, weight = invaderXim.loot.weight.EXTREMELY_LOW },
        { item = invaderXim.item.AUTO_REPAIR_KIT_II, weight = invaderXim.loot.weight.EXTREMELY_LOW },
        { item = invaderXim.item.MANA_TANK_II, weight = invaderXim.loot.weight.EXTREMELY_LOW },
        { item = invaderXim.item.STABILIZER_II, weight = invaderXim.loot.weight.EXTREMELY_LOW },
    },
