...
local content = Battlefield:new({
    ...
    battlefieldId    = invaderXim.battlefield.id.PREHISTORIC_PIGEONS,
    maxPlayers       = 6,
    timeLimit        = utils.minutes(30),
    index            = 18,
    entryNpc         = 'BC_Entrance',
    exitNpc          = 'Burning_Circle',
    requiredItems    = { invaderXim.item.ATROPOS_ORB, wearMessage = waughroonID.text.A_CRACK_HAS_FORMED, wornMessage = waughroonID.text.ORB_IS_CRACKED },
...
{
    {
        ...
        { item = invaderXim.item.DISSECTOR,           weight = 174 }, -- Dissector
        { item = invaderXim.item.COFFINMAKER,         weight = 333 }, -- Coffinmaker
        { item = invaderXim.item.GRAVEDIGGER,         weight = 174 }, -- Gravedigger
    },

    {
        { item = invaderXim.item.CLAYMORE_GRIP,    weight = 144 }, -- Claymore Grip
        { item = invaderXim.item.DAMASCUS_INGOT,   weight = 275 }, -- Damascus Ingot
        { item = invaderXim.item.GIANT_BIRD_PLUME, weight = 275 }, -- Giant Bird Plume
...

    {
        ...
        { item = invaderXim.item.TITANIS_EARRING,  weight = 406 }, -- Titanis Earring
    },
...

    {
        ...
        { item = invaderXim.item.GOLD_INGOT,              weight = 101 }, -- Gold Ingot
        ...
        { item = invaderXim.item.SPOOL_OF_MALBORO_FIBER,  weight =  72 }, -- Spool Of Malboro Fiber
    },
