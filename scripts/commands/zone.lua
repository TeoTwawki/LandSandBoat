...
local zoneList =
{
    { 0x14, 0xA9, invaderXim.zone.PHANAUET_CHANNEL             },
    ...
    { 0x14, 0x9E, invaderXim.zone.PROMYVION_DEM                },
    { 0x14, 0x9D, invaderXim.zone.PROMYVION_DEM                },
    ...
    { 0x14, 0xC4, invaderXim.zone.SILVER_SEA_ROUTE_TO_NASHMAU  },
    { 0x14, 0xC5, invaderXim.zone.SILVER_SEA_ROUTE_TO_AL_ZAHBI },
    ...
    { 0x27, 0x0F, invaderXim.zone.CHOCOBO_CIRCUIT              },
...
commandObj.onTrigger = function(player, bytes)
    ...
    if atpos ~= nil then
        ...
        zone = tonumber(bytes)
        if zone == nil or zone < 0 or zone >= invaderXim.zone.MAX_ZONE then
