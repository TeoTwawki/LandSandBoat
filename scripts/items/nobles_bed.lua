...
itemObject.onFurniturePlaced = function(player)
    if player:getQuestStatus(invaderXim.questLog.OTHER_AREAS, invaderXim.quest.id.otherAreas.MOOGLES_IN_THE_WILD) == invaderXim.questStatus.QUEST_AVAILABLE then
