...
itemObject.onItemUse = function(target)
    target:addStatusEffect(invaderXim.effect.FOOD, 0, 0, 10800, 4507)
end
...
itemObject.onEffectGain = function(target, effect)
    ...
    target:addMod(invaderXim.mod.FOOD_RATT_CAP, 20)
end
...
itemObject.onEffectLose = function(target, effect)
    ...
    target:delMod(invaderXim.mod.FOOD_RATT_CAP, 20)
end
