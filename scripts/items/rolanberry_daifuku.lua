...
itemObject.onItemUse = function(target)
    target:addStatusEffect(invaderXim.effect.FOOD, 0, 0, 1800, 6339)
end
...
itemObject.onEffectGain = function(target, effect)
    ...
    target:addMod(invaderXim.mod.MACC, 50)
    target:addPetMod(invaderXim.mod.FOOD_HP, 20)
    target:addPetMod(invaderXim.mod.DEX, 2)
    ...
    target:addPetMod(invaderXim.mod.MACC, 75)
end
...
itemObject.onEffectLose = function(target, effect)
    ...
    target:delMod(invaderXim.mod.MACC, 50)
    target:delPetMod(invaderXim.mod.FOOD_HP, 20)
    target:delPetMod(invaderXim.mod.DEX, 2)
    ...
    target:delPetMod(invaderXim.mod.MACC, 75)
end
