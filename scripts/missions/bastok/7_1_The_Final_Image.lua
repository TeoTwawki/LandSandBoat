...
local mission = Mission:new(invaderXim.mission.log_id.BASTOK, invaderXim.mission.id.bastok.THE_FINAL_IMAGE)
            ...
            onEventFinish =
            {
                ...
                [764] = function(player, csid, option, npc)
                    if mission:complete(player) then
                        player:delKeyItem(invaderXim.ki.REINFORCED_CERMET)
                    end
                end,
            },
        },
                ...
                onTrigger = function(player, npc)
                    if player:getMissionStatus(mission.areaId) == 1 then
                        if mission:getLocalVar(player, 'nmDefeated') == 1 then
                            ...
                            return mission:keyItem(invaderXim.ki.REINFORCED_CERMET)
                        else
