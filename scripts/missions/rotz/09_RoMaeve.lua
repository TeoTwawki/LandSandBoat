...
local mission = Mission:new(invaderXim.mission.log_id.ZILART, invaderXim.mission.id.zilart.ROMAEVE)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.ZILART, invaderXim.mission.id.zilart.THE_TEMPLE_OF_DESOLATION },
}
