...
local mission = Mission:new(invaderXim.mission.log_id.SOA, invaderXim.mission.id.soa.MEETING_OF_THE_MINDS)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.SOA, invaderXim.mission.id.soa.ARCIELA_APPEARS_AGAIN },
}
        ...
        [invaderXim.zone.EASTERN_ADOULIN] =
        {
            ...
            onEventFinish =
            {
                [1500] = function(player, csid, option, npc)
                    player:delKeyItem(invaderXim.ki.DINNER_INVITATION)
