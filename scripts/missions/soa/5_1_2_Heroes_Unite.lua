...
local mission = Mission:new(invaderXim.mission.log_id.SOA, invaderXim.mission.id.soa.HEROES_UNITE)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.SOA, invaderXim.mission.id.soa.A_PORTENT_MOST_OMINOUS },
}
            ...
            onEventFinish =
            {
                [60] = function(player, csid, option, npc)
                    if option == 1 then
                        ...
                        player:setPos(306.42, -0.073, -24.974, 199, invaderXim.zone.MOUNT_KAMIHR)
                    end
                end,
            },
        },
