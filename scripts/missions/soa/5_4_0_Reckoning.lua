...
local mission = Mission:new(invaderXim.mission.log_id.SOA, invaderXim.mission.id.soa.RECKONING)

mission.reward =
{
    keyItem     = invaderXim.ki.AWAKENED_CRYSTALLIZED_PSYCHE,
    nextMission = { invaderXim.mission.log_id.SOA, invaderXim.mission.id.soa.ABOMINATION },
}
...
{
    {
        ...
        [invaderXim.zone.RAKAZNAR_INNER_COURT] =
        {
            afterZoneIn = function(player)
                if
                    not player:hasKeyItem(invaderXim.ki.CRYSTALLIZED_PSYCHE) and
