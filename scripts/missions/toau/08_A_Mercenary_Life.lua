...
local mission = Mission:new(invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.A_MERCENARY_LIFE)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.UNDERSEA_SCOUTING },
}
