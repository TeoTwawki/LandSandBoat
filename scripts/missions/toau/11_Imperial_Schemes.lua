...
local mission = Mission:new(invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.IMPERIAL_SCHEMES)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.ROYAL_PUPPETEER },
}
