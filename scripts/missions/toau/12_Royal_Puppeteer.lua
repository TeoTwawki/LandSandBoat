...
local mission = Mission:new(invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.ROYAL_PUPPETEER)

mission.reward =
{
    keyItem     = invaderXim.ki.VIAL_OF_SPECTRAL_SCENT,
    nextMission = { invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.LOST_KINGDOM },
}
            ...
            ['Pyopyoroon'] =
            {
                onTrade = function(player, npc, trade)
                    if
                        ...
                        npcUtil.tradeHasExactly(trade, invaderXim.item.VIAL_OF_JODYS_ACID)
                    then
