...
local mission = Mission:new(invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.SOCIAL_GRACES)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.FOILED_AMBITION },
}
