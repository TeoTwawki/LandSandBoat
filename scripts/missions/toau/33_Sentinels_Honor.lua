...
local mission = Mission:new(invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.SENTINELS_HONOR)

mission.reward =
{
    nextMission = { invaderXim.mission.log_id.TOAU, invaderXim.mission.id.toau.TESTING_THE_WATERS },
}
