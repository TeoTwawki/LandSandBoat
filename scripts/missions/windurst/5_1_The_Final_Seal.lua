...
local mission = Mission:new(invaderXim.mission.log_id.WINDURST, invaderXim.mission.id.windurst.THE_FINAL_SEAL)
...
local handleAcceptMission = function(player, csid, option, npc)
    ...
    player:delKeyItem(invaderXim.ki.MESSAGE_TO_JEUNO_WINDURST)
end
        ...
        [invaderXim.zone.HEAVENS_TOWER] =
        {
            ['_6q2'] =
            {
                onTrigger = function(player, npc)
                    ...
                    if player:hasKeyItem(invaderXim.ki.MESSAGE_TO_JEUNO_WINDURST) then
