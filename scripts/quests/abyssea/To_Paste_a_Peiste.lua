...
local quest = Quest:new(invaderXim.questLog.ABYSSEA, invaderXim.quest.id.abyssea.TO_PASTE_A_PEISTE)
...
quest.sections =
{
    ...
    {
        check = function(player, status, vars)
            return status == invaderXim.questStatus.QUEST_ACCEPTED and player:hasTitle(invaderXim.title.KUKULKAN_DEFANGER)
        end,
