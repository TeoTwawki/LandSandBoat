...
zones[invaderXim.zone.ABYSSEA_ALTEPA] =
{
    text =
    {
        ...
        DOMINION_SIGNED_ON            = 10419, -- You have signed on for Dominion Ops!
        CANCELED_OBJECTIVE            = 10420, -- You have canceled your objective.
    },
    mob =
    {
...
return zones[invaderXim.zone.ABYSSEA_ALTEPA]
