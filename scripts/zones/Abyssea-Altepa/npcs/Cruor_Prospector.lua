...
local prospectorItems =
{
    ...
    {
    --  Sel      Item                            Cost
        [ 1] = { invaderXim.item.RAVAGERS_MUFFLERS,     5000 },
        [ 2] = { invaderXim.item.TANTRA_GLOVES,         5000 },
        [ 3] = { invaderXim.item.ORISON_MITTS,          5000 },
        [ 4] = { invaderXim.item.GOETIA_GLOVES,         5000 },
        [ 5] = { invaderXim.item.ESTOQUEURS_GANTHEROTS, 5000 },
        [ 6] = { invaderXim.item.RAIDERS_ARMLETS,       5000 },
        [ 7] = { invaderXim.item.UTILIS_SHIELD,         5000 },
        [ 8] = { invaderXim.item.PYF_HARP,              5000 },
        [ 9] = { invaderXim.item.FORBIDDEN_KEY,          500 },
        [10] = { invaderXim.item.SHADOW_THRONE,      2000000 },
    },
    ...
    {
    --  Sel     Item                                 Cost
        [1] = { invaderXim.ki.MAP_OF_ABYSSEA_ALTEPA,         4500 },
