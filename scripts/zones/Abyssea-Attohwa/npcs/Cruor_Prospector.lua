...
local prospectorItems =
{
    ...
    {
    --  Sel      Item                         Cost
        [ 1] = { invaderXim.item.RAVAGERS_MASK,      5000 },
        [ 2] = { invaderXim.item.TANTRA_CROWN,       5000 },
        [ 3] = { invaderXim.item.ORISON_CAP,         5000 },
        [ 4] = { invaderXim.item.GOETIA_PETASOS,     5000 },
        [ 5] = { invaderXim.item.ESTOQUEURS_CHAPPEL, 5000 },
        [ 6] = { invaderXim.item.RAIDERS_BONNET,     5000 },
        [ 7] = { invaderXim.item.FORBIDDEN_KEY,       500 },
        [ 8] = { invaderXim.item.SHADOW_THRONE,   2000000 },
    },
    ...
    {
    --  Sel     Item                                 Cost
        [1] = { invaderXim.ki.MAP_OF_ABYSSEA_ATTOHWA,        4500 },
