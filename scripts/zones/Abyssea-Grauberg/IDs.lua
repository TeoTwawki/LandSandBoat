...
zones[invaderXim.zone.ABYSSEA_GRAUBERG] =
{
    text =
    {
        ...
        PLAYER_GAINED_EXPERIENCE      = 7000,  -- <name> gained <number> [points of experience/limit points].
        ...
        OBTAINS_DOMINION_NOTES        = 7884,  -- <name> obtains <number> Dominion note[/s] (Total: <number>).
        DOMINION_SIGNED_ON            = 10420, -- You have signed on for Dominion Ops!
        CANCELED_OBJECTIVE            = 10421, -- You have canceled your objective.
    },
    mob =
    {
...
return zones[invaderXim.zone.ABYSSEA_GRAUBERG]
