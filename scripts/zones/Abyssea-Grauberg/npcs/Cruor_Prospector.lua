...
local prospectorItems =
{
    ...
    {
    --  Sel      Item                         Cost
        [ 1] = { invaderXim.item.UNKAI_KOTE,         5000 },
        [ 2] = { invaderXim.item.IGA_TEKKO,          5000 },
        [ 3] = { invaderXim.item.LANCERS_VAMBRACES,  5000 },
        [ 4] = { invaderXim.item.CALLERS_BRACERS,    5000 },
        [ 5] = { invaderXim.item.MAVI_BAZUBANDS,     5000 },
        [ 6] = { invaderXim.item.NAVARCHS_GANTS,     5000 },
        [ 7] = { invaderXim.item.CIRQUE_GUANTI,      5000 },
        [ 8] = { invaderXim.item.CHARIS_BANGLES,     5000 },
        [ 9] = { invaderXim.item.SAVANTS_BRACERS,    5000 },
        [10] = { invaderXim.item.UTILIS_SHIELD,      5000 },
        [11] = { invaderXim.item.PYF_HARP,           5000 },
        [12] = { invaderXim.item.FORBIDDEN_KEY,       500 },
        [13] = { invaderXim.item.SHADOW_THRONE,   2000000 },
    },
    ...
    {
    --  Sel     Item                                 Cost
        [1] = { invaderXim.ki.MAP_OF_ABYSSEA_GRAUBERG,       4500 },
        [2] = { invaderXim.ki.IVORY_ABYSSITE_OF_MERIT,       6000 },
        [3] = { invaderXim.ki.IVORY_ABYSSITE_OF_FURTHERANCE, 7500 },
        [4] = { invaderXim.ki.IVORY_ABYSSITE_OF_CELERITY,    9000 },
