...
local prospectorItems =
{
    ...
    {
    --  Sel      Item                         Cost
        [ 1] = { invaderXim.item.CREED_GAUNTLETS,    5000 },
        [ 2] = { invaderXim.item.BALE_GAUNTLETS,     5000 },
        [ 3] = { invaderXim.item.FERINE_MANOPLAS,    5000 },
        [ 4] = { invaderXim.item.AOIDOS_MANCHETTES,  5000 },
        [ 5] = { invaderXim.item.SYLVAN_GLOVELETTES, 5000 },
        [ 6] = { invaderXim.item.UTILIS_SHIELD,      5000 },
        [ 7] = { invaderXim.item.PYF_HARP,           5000 },
        [ 8] = { invaderXim.item.FORBIDDEN_KEY,       500 },
        [ 9] = { invaderXim.item.SHADOW_THRONE,   2000000 },
    },
    ...
    {
    --  Sel     Item                                 Cost
        [1] = { invaderXim.ki.MAP_OF_ABYSSEA_ULEGUERAND,     4500 },
