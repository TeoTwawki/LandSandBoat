...
entity.onTrade = function(player, npc, trade)
    ...
    if
        ...
        trade:hasItemQty(invaderXim.item.FIRST_VIRTUE, 1) and -- first_virtue
        trade:hasItemQty(invaderXim.item.DEED_OF_PLACIDITY, 1) and -- deed_of_placidity
        trade:hasItemQty(invaderXim.item.HIGH_QUALITY_PHUABO_ORGAN, 1) and -- high-quality_phuabo_organ
