...
entity.onTrade = function(player, npc, trade)
    if
        ...
        trade:hasItemQty(invaderXim.item.FOURTH_VIRTUE, 1) and
        trade:hasItemQty(invaderXim.item.FIFTH_VIRTUE, 1) and
        trade:hasItemQty(invaderXim.item.SIXTH_VIRTUE, 1) and
