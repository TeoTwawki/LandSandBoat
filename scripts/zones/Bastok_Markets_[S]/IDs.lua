...
zones[invaderXim.zone.BASTOK_MARKETS_S] =
{
    text =
    {
        ...
        ARE_TAKEN_AWAY_FROM_CHAR      = 11550, -- The <keyitem> are taken away from <player>!
...
return zones[invaderXim.zone.BASTOK_MARKETS_S]
