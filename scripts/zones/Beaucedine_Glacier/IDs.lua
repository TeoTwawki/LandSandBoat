...
zones[invaderXim.zone.BEAUCEDINE_GLACIER] =
{
    text =
    {
        ...
        CONQUEST                       = 7502,  -- You've earned conquest points!
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8647,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
...
return zones[invaderXim.zone.BEAUCEDINE_GLACIER]
