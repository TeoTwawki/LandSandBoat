...
entity.onMobSpawn = function(mob)
    ...
    if mobID == ID.mob.EMPATHIC_FLAN[1] or mobID == ID.mob.EMPATHIC_FLAN[3] then
        mob:setMod(invaderXim.mod.UDMGMAGIC, 2125)
        ...
        if mobArg:getHP() > 0 then
            ...
            if mobArg:getHPP() < 90 and firstShift == 0 then
                if mobArg:getLocalVar('physical') > mobArg:getLocalVar('magical') + mobArg:getMaxHP() * 0.1 then
                    ...
                    mobArg:setMod(invaderXim.mod.UDMGPHYS, -75)
                    mobArg:setMod(invaderXim.mod.UDMGRANGE, -75)
                    mobArg:setMod(invaderXim.mod.UDMGMAGIC, 2900)
                ...
                elseif mobArg:getLocalVar('magical') > mobArg:getLocalVar('physical') + mobArg:getMaxHP() * 0.1 then
                    ...
                    mobArg:setMod(invaderXim.mod.UDMGPHYS, -25)
                    mobArg:setMod(invaderXim.mod.UDMGRANGE, -25)
                    mobArg:setMod(invaderXim.mod.UDMGMAGIC, 562)
            ...
            elseif mobArg:getAnimationSub() == 2 and firstShift > 0 then
                ...
                if mobArg:getLocalVar('magical') > threshold then
                    ...
                    mobArg:setMod(invaderXim.mod.UDMGPHYS, -50)
                    mobArg:setMod(invaderXim.mod.UDMGRANGE, -50)
                    mobArg:setMod(invaderXim.mod.UDMGMAGIC, 2125)
                    mobArg:setLocalVar('physical', 0)
                end
            elseif mobArg:getAnimationSub() == 0 and firstShift > 0 then
                ...
                if
                    ...
                    (attackType == invaderXim.attackType.PHYSICAL or attackType == invaderXim.attackType.RANGED)
                then
                ...
                elseif
                    ...
                    attackType ~= invaderXim.attackType.PHYSICAL and
                    attackType ~= invaderXim.attackType.RANGED
                then
                    mobArg:setAnimationSub(1)
                    mobArg:setMod(invaderXim.mod.UDMGPHYS, -25)
