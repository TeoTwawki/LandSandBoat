...
entity.onEventFinish = function(player, csid, option, npc)
    if csid == 300 and option == 1 then
        ...
        if instance and invaderXim.salvage.onDoorOpen(npc, nil, 2) then
            invaderXim.salvage.sealDoors(instance, ID.npc.DOOR_2_EAST_ENTRANCE)
            invaderXim.salvage.unsealDoors(instance, { ID.npc.DOOR_2_SW_ENTRANCE, ID.npc.DOOR_2_NW_ENTRANCE })
            local mobs =
            {
