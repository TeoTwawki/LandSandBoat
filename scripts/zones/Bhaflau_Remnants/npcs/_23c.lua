...
entity.onEventFinish = function(player, csid, option, npc)
    if csid == 300 and option == 1 then
        ...
        if instance and invaderXim.salvage.onDoorOpen(npc, nil, 1) then
            invaderXim.salvage.sealDoors(instance, ID.npc.DOOR_2_WEST_ENTRANCE)
            invaderXim.salvage.unsealDoors(instance, { ID.npc.DOOR_2_SE_ENTRANCE, ID.npc.DOOR_2_NE_ENTRANCE })
            local mobs =
            {
