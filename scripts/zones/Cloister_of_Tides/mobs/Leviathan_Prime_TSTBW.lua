...
entity.onMobSpawn = function(mob)
    ...
    mob:setMod(invaderXim.mod.WATER_RES_RANK, -3)
...
entity.onAdditionalEffect = function(mob, target, damage)
    return invaderXim.mob.onAddEffect(mob, target, damage, invaderXim.mob.ae.ENWATER, { chance = 100, power = math.random(15, 25) })
end
