...
entity.onMobSpawn = function(mob)
    ...
    mob:setMod(invaderXim.mod.EARTH_RES_RANK, -3)
...
entity.onAdditionalEffect = function(mob, target, damage)
    return invaderXim.mob.onAddEffect(mob, target, damage, invaderXim.mob.ae.ENSTONE, { chance = 100, power = math.random(20, 40) })
end
