...
zones[invaderXim.zone.EAST_RONFAURE] =
{
    text =
    {
        ...
        RAYOCHINDOT_DIALOG            = 7429,  -- If you are outmatched, run to the city as quickly as you can.
        CROTEILLARD_DIALOG            = 7430,  -- Sorry, no chatting while I'm on duty.
        ANDELAIN_DIALOG               = 7431,  -- My name is Andelain. As part of my devotions, I come here each day to pray.
        MAY_ONLY_EAT                  = 7432,  -- During this time, I may eat only three <item> a day for nourishment. No more, no less. And no other food may I eat.
        THANKS_TO_GODDESS             = 7433,  -- Thanks be to the Goddess in her benevolence!
        CANNOT_ACCEPT_ALMS            = 7434,  -- I am currently undergoing devotions, and as such, am not allowed to take alms from those on the road. I am sorry, but I cannot accept this.
        GATES_OF_PARADISE_OPEN        = 7435,  -- May the Gates of Paradise open to all...
        APPRECIATE_OFFER_DECLINE      = 7436,  -- I appreciate your offer, but I only need one <item>. Thank you for your kindness.
        THE_WATER_SPARKLES            = 7454,  -- The water sparkles in the light.
        CHEVAL_RIVER_WATER            = 7455,  -- You fill your waterskin with water from the river. You now have <item>.
        BLESSED_WATERSKIN             = 7474,  -- To get water, trade the waterskin you hold with the river.
        LOGGING_IS_POSSIBLE_HERE      = 7505,  -- Logging is possible here if you have <item>.
        ...
        REGIME_REGISTERED             = 9885,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 11058, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11059, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11060, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11061, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11063, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11064, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11065, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11066, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                  = 11956, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 11958, -- You are assaulted by an uncanny sensation.
    },
