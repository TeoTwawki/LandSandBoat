...
entity.onMobDeath = function(mob, player, optParams)
    invaderXim.voidwalker.onMobDeath(mob, player, optParams, invaderXim.keyItem.BLUE_ABYSSITE)
    invaderXim.hunts.checkHunt(mob, player, 546)
    invaderXim.magian.onMobDeath(mob, player, optParams, set{ 157, 371, 585 })
end
