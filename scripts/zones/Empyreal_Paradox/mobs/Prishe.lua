...
entity.onMobRoam = function(mob)
    ...
    if ready == 0 and wait > 240 then
        if GetMobByID(promathia):getCurrentAction() ~= invaderXim.act.NONE then
...
entity.onMobEngage = function(mob, target)
    ...
    mob:addStatusEffectEx(invaderXim.effect.SILENCE, 0, 0, 0, 5)
end
