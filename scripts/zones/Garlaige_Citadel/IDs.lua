...
zones[invaderXim.zone.GARLAIGE_CITADEL] =
{
    text =
    {
        ...
        DEVICE_NOT_WORKING            = 7252,  -- The device is not working.
        SYS_OVERLOAD                  = 7261,  -- Warning! Sys...verload! Enterin...fety mode. ID eras...d.
        YOU_LOST_THE                  = 7266,  -- You lost the <item>.
        SPARKLING_LIGHT               = 7278,  -- The ground is sparkling with a strange light.
        A_GATE_OF_STURDY_STEEL        = 7290,  -- A gate of sturdy steel.
        OPEN_WITH_THE_RIGHT_KEY       = 7296,  -- You might be able to open it with the right key.
        BANISHING_GATES               = 7305,  -- The first banishing gate begins to open...
        BANISHING_GATES_CLOSING       = 7308,  -- The first banishing gate starts to close.
        YOU_FIND_NOTHING              = 7312,  -- You find nothing special.
        HOLE_IN_THE_CEILING           = 7313,  -- There is a hole in the ceiling.
        PRESENCE_FROM_CEILING         = 7314,  -- You sense a presence from in the ceiling.
        HEAT_FROM_CEILING             = 7315,  -- You feel a terrible heat from the ceiling.
        THE_PRESENCE_MOVES            = 7319,  -- The presence in the ceiling seems to have moved to the east.
        CHEST_UNLOCKED                = 7345,  -- You unlock the chest!
        ITEMS_ITEMS_LA_LA             = 7472,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY           = 7478,  -- The Goblin slipped away when you were not looking...
        YOU_COULD_OPEN_THE_GATE       = 7530,  -- If only you had %, you could open the banishing gate...
        THE_GATE_OPENS_FOR_YOU        = 7531,  -- By the power of your %, the gate opens for you.
        COMBINE_INTO_A_CHUNK          = 7533,  -- You combine the % you have collected into a single chunk.
        ...
        COMMON_SENSE_SURVIVAL         = 11575, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 11639, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
...
return zones[invaderXim.zone.GARLAIGE_CITADEL]
