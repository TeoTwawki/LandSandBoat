...
zones[invaderXim.zone.GHEIXIMA_OUTPOST] =
{
    text =
    {
        ...
        ITEM_OBTAINED                    = 6923, -- Obtained: <item>.
        GIL_OBTAINED                     = 6924, -- Obtained <number> gil.
        KEYITEM_OBTAINED                 = 6926, -- Obtained key item: <keyitem>.
        NOTHING_OUT_OF_ORDINARY          = 6937, -- There is nothing out of the ordinary here.
        FELLOW_MESSAGE_OFFSET            = 6952, -- I'm ready. I suppose.
        CARRIED_OVER_POINTS              = 7534, -- You have carried over <number> login point[/s].
