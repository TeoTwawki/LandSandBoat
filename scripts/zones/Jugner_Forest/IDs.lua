...
zones[invaderXim.zone.JUGNER_FOREST] =
{
    text =
    {
        ...
        FISHING_MESSAGE_OFFSET        = 7723,  -- You can't fish here.
        DIG_THROW_AWAY                = 7736,  -- You dig up <item>, but your inventory is full. You regretfully throw the <item> away.
        FIND_NOTHING                  = 7738,  -- You dig and you dig, but find nothing.
