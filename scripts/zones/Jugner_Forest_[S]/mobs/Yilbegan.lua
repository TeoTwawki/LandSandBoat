...
entity.onMobDeath = function(mob, player, optParams)
    player:addTitle(invaderXim.title.YILBEGAN_HIDEFLAYER)
    invaderXim.voidwalker.onMobDeath(mob, player, optParams, nil)
    invaderXim.hunts.checkHunt(mob, player, 559)
end
