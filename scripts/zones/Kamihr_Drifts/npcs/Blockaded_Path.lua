...
entity.onTrigger = function(player, npc)
    ...
    if player:getCurrentMission(invaderXim.mission.log_id.SOA) >= invaderXim.mission.id.soa.A_SHROUDED_CANOPY then
...
entity.onEventFinish = function(player, csid, option, npc)
    if csid == 57 and option == 1 then
        player:setPos(16.725, 0.493, -19.652, 131, invaderXim.zone.LEAFALLIA)
    end
end
