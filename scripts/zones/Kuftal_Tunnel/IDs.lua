...
zones[invaderXim.zone.KUFTAL_TUNNEL] =
{
    text =
    {
        ...
        DO_NOT_SEE_ANYTHING           = 7350,  -- You do not see anything out of the ordinary.
        FELL                          = 7353,  -- The piece of wood fell off the cliff!
        EVIL                          = 7354,  -- You sense an evil presence...
        FISHBONES                     = 7368,  -- Fish bones lie scattered about the area...
