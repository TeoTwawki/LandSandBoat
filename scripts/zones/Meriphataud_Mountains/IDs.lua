...
zones[invaderXim.zone.MERIPHATAUD_MOUNTAINS] =
{
    text =
    {
        ...
        NOTHING_FOUND                 = 7507,  -- You find nothing.
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 8426,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        TIME_ELAPSED                  = 8504,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
