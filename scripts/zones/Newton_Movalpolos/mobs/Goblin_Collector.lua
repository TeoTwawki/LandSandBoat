...
entity.onMobSpawn = function(mob)
    ...
    mob:setMod(invaderXim.mod.MATT, 150)
    mob:setMod(invaderXim.mod.BIND_MEVA, 40)
    mob:setMod(invaderXim.mod.GRAVITY_MEVA, 40)
    mob:setMod(invaderXim.mod.TRIPLE_ATTACK, 20)
    mob:showText(mob, ID.text.COLLECTOR_SPAWN, invaderXim.item.PREMIUM_BAG)
end
