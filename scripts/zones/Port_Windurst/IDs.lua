...
zones[invaderXim.zone.PORT_WINDURST] =
{
    text =
    {
        ...
        ITEM_OBTAINED                   = 10974, -- Obtained: <item>.
        GIL_OBTAINED                    = 10975, -- Obtained <number> gil.
        KEYITEM_OBTAINED                = 10977, -- Obtained key item: <keyitem>.
        KEYITEM_LOST                    = 10978, -- Lost key item: <keyitem>.
        NOT_HAVE_ENOUGH_GIL             = 10979, -- You do not have enough gil.
        CARRIED_OVER_POINTS             = 11013, -- You have carried over <number> login point[/s].
        LOGIN_CAMPAIGN_UNDERWAY         = 11014, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!
        LOGIN_NUMBER                    = 11015, -- In celebration of your most recent login (login no. <number>), we have provided you with <number> points! You currently have a total of <number> points.
        MEMBERS_LEVELS_ARE_RESTRICTED   = 11035, -- Your party is unable to participate because certain members' levels are restricted.
        HOMEPOINT_SET                   = 11081, -- Home point set!
        YOU_ACCEPT_THE_MISSION          = 11174, -- You have accepted the mission.
        KHEL_PAHLHAMA_SHOP_DIALOG       = 11220, -- These magic shells are full of mysteries...
        MAP_MARKER_TUTORIAL             = 11413, -- The map will open when you select Map from the main menu. Choose Markers and scroll to the right to check the location.
        MOG_LOCKER_OFFSET               = 11498, -- Your Mog Locker lease is valid until <timestamp>, kupo.
        FISHING_MESSAGE_OFFSET          = 11610, -- You can't fish here.
        IMAGE_SUPPORT                   = 11714, -- Your [fishing/woodworking/smithing/goldsmithing/clothcraft/leatherworking/bonecraft/alchemy/cooking] skills went up [a little/ever so slightly/ever so slightly].
        GUILD_TERMINATE_CONTRACT        = 11728, -- You have terminated your trading contract with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and formed a new one with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild.
        GUILD_NEW_CONTRACT              = 11736, -- You have formed a new trading contract with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild.
        NO_MORE_GP_ELIGIBLE             = 11743, -- You are not eligible to receive guild points at this time.
        GP_OBTAINED                     = 11748, -- Obtained: <number> guild points.
        NOT_HAVE_ENOUGH_GP              = 11749, -- You do not have enough guild points.
        RYAN_SHOP_DIALOG                = 11863, -- I have no time for white-livered scum that rely on magic alone. If you're with me then check out these wares from across the high seas.
        DROZGA_SHOP_DIALOG              = 11864, -- Ho there, young [man/lady]! Not only is Ryan a boorish lout, but his craftsmanship leaves much to be desired, as well. You're better off buyin' from me.
        CONQUEST                        = 11930, -- You've earned conquest points!
        KOHLO_LAKOLO_DIALOG_A           = 12473, -- On your Star Onion Brigade honor, you can't tell anybody that Joker is hiding in the ghosty house!
        LEBONDUR_OPEN_DIALOG            = 12584, -- I've risked my life traveling all the way from Vollbow to bring you these fine goods!
        LEBONDUR_CLOSED_DIALOG          = 12585, -- Where is my shipment from Vollbow? This is terrible for my image as a respected importer...
        SATTSUHAHKANPARI_OPEN_DIALOG    = 12586, -- You can look, but don't touch! And rememberrr, you break it, you bought it!
        ...
        RETRIEVE_DIALOG_ID              = 15923, -- You retrieve <item> from the porter moogle's care.
        OBTAINED_NUM_KEYITEMS           = 15965, -- Obtained key item: <number> <keyitem>!
        NOT_ACQUAINTED                  = 15967, -- I'm sorry, but I don't believe we're acquainted. Please leave me be.
        COMMON_SENSE_SURVIVAL           = 16337, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
    },
