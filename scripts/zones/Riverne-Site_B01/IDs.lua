...
zones[invaderXim.zone.RIVERNE_SITE_B01] =
{
    text =
    {
        ...
        NOTHING_OUT_OF_THE_ORDINARY   = 7615, -- There is nothing out of the ordinary here.
...
return zones[invaderXim.zone.RIVERNE_SITE_B01]
