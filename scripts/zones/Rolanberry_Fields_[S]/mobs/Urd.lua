...
entity.onMobDeath = function(mob, player, optParams)
    invaderXim.voidwalker.onMobDeath(mob, player, optParams, invaderXim.keyItem.YELLOW_ABYSSITE)
    invaderXim.hunts.checkHunt(mob, player, 554)
    invaderXim.magian.onMobDeath(mob, player, optParams, set{ 222, 650, 716, 947 })
end
