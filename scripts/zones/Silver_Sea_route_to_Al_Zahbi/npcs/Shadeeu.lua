...
-----------------------------------
local ID = zones[invaderXim.zone.SILVER_SEA_ROUTE_TO_AL_ZAHBI]
-----------------------------------
---@type TNpcEntity
local entity = {}
...
local messages =
{
    [invaderXim.transport.message.NEARING] = ID.text.NEARING_AL_ZAHBI,
    [invaderXim.transport.message.DOCKING] = ID.text.DOCKING_IN_AL_ZAHBI
}
...
entity.onTrigger = function(player, npc)
    invaderXim.transport.onBoatTimekeeperTrigger(player, invaderXim.transport.routes.SILVER_SEA, ID.text.ON_WAY_TO_AL_ZAHBI, ID.text.ARRIVING_SOON_AL_ZAHBI)
end
