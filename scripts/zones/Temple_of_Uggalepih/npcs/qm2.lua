...
entity.onTrigger = function(player, npc)
    if not player:hasItem(invaderXim.item.OFFERING_TO_UGGALEPIH) then
        if npcUtil.giveItem(player, invaderXim.item.OFFERING_TO_UGGALEPIH) then -- Uggalepih Offering
