...
entity.onTrigger = function(player, npc)
    ...
    if offset >= 0 and offset <= 20 then
        local y = (offset <= 8) and invaderXim.anim.OPEN_DOOR or invaderXim.anim.CLOSE_DOOR
        local b = (offset <= 8) and invaderXim.anim.CLOSE_DOOR or invaderXim.anim.OPEN_DOOR
