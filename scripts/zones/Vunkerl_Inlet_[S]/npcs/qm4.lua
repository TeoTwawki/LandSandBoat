...
entity.onTrigger = function(player, npc)
    if
        player:getQuestStatus(invaderXim.questLog.CRYSTAL_WAR, invaderXim.quest.id.crystalWar.REDEEMING_ROCKS) and
        player:getCharVar('RedeemingRocksProg') == 3
    then
        npcUtil.giveKeyItem(player, invaderXim.ki.PIECE_OF_KIONITE)
