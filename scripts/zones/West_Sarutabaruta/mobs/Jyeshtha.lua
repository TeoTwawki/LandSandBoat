...
entity.onMobDeath = function(mob, player, optParams)
    invaderXim.voidwalker.onMobDeath(mob, player, optParams, invaderXim.keyItem.BROWN_ABYSSITE)
    invaderXim.hunts.checkHunt(mob, player, 551)
    invaderXim.magian.onMobDeath(mob, player, optParams, set{ 156, 370, 584 })
end
