...
entity.onTrigger = function(player, npc)
    ...
    if DELM == invaderXim.questStatus.QUEST_ACCEPTED and player:getCharVar('DELM_Dewalt_Branch') < 1 then
        -- Progresses Quest: 'Dont Ever Leaf Me'
        player:startEvent(5013)
    elseif DELM == invaderXim.questStatus.QUEST_ACCEPTED and player:getCharVar('DELM_Dewalt_Branch') < 2 then
