...
entity.onTrigger = function(player, npc)
    ...
    if raptorRapture == invaderXim.questStatus.QUEST_AVAILABLE then
    ...
    elseif raptorRapture == invaderXim.questStatus.QUEST_ACCEPTED then
        ...
        elseif raptorRaptureStatus == 6 then
            local hasRockberries = player:hasKeyItem(invaderXim.ki.ROCKBERRY1) and player:hasKeyItem(invaderXim.ki.ROCKBERRY2) and player:hasKeyItem(invaderXim.ki.ROCKBERRY3)
...
entity.onEventFinish = function(player, csid, option, npc)
    ...
    elseif csid == 5037 then
        ...
        player:delKeyItem(invaderXim.ki.ROCKBERRY1)
        player:delKeyItem(invaderXim.ki.ROCKBERRY2)
        player:delKeyItem(invaderXim.ki.ROCKBERRY3)
    ...
    elseif csid == 5039 then
        ...
        player:completeQuest(invaderXim.questLog.ADOULIN, invaderXim.quest.id.adoulin.RAPTOR_RAPTURE)
