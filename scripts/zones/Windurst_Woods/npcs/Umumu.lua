...
entity.onTrigger = function(player, npc)
    ...
    local lureOfTheWildcat = player:getQuestStatus(invaderXim.questLog.WINDURST, invaderXim.quest.id.windurst.LURE_OF_THE_WILDCAT)
    ...
    elseif makingHeadlines == invaderXim.questStatus.QUEST_COMPLETED then
...
entity.onEventFinish = function(player, csid, option, npc)
    if csid == 381 then
        npcUtil.giveKeyItem(player, invaderXim.ki.WINDURST_WOODS_SCOOP)
