...
entity.onTrigger = function(player, npc)
    ...
    if offset == 0 then
        ...
        elseif
            evenmoreTravelsStatus == invaderXim.questStatus.QUEST_COMPLETED and
            scentReady and
...
entity.onEventFinish = function(player, csid, option, npc)
    ...
    if csid == 21 and option == 1 then
        ...
        then
            ...
            npcUtil.giveItem(player, invaderXim.item.JAR_OF_RAFFLESIA_NECTAR)
            player:messageSpecial(ID.text.FEEL_DIZZY) -- You feel slightly dizzy. You must have breathed in too much of the pollen.
            if evenmoreTravelsStatus == invaderXim.questStatus.QUEST_ACCEPTED then
